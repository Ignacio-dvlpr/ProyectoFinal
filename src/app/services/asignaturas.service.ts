...
export class AsignaturasService {
  asignaturasAux: InterfazAsignatura[] = [];
  ...
  constructor() {}
  getAllAsignaturas(): InterfazAsignatura[] {
    return this.asignaturas;
  }

  getAsignaturasDam(): InterfazAsignatura[] {
    return this.asignaturas.filter((e) => {
      return e.ciclo.toLowerCase().includes('DAM'.toLowerCase());
    });
  }
  getAsignaturas1(): InterfazAsignatura[] {
    return this.asignaturas.filter((e) => {
      return (
        e.ciclo.toLowerCase().includes('DAM'.toLowerCase()) && e.curso == 1
      );
    });
  }
  getAsignaturasDam2(): InterfazAsignatura[] {
    return this.asignaturas.filter((e) => {
      return (
        e.ciclo.toLowerCase().includes('DAM'.toLowerCase()) && e.curso == 2
      );
    });
  }
  getAsignaturasDaw(): InterfazAsignatura[] {
    return this.asignaturas.filter((e) => {
      return e.ciclo.toLowerCase().includes('DAW'.toLowerCase());
    });
  }
  getAsignaturasDaw2(): InterfazAsignatura[] {
    return this.asignaturas.filter((e) => {
      return (
        e.ciclo.toLowerCase().includes('DAW'.toLowerCase()) && e.curso == 2
      );
    });
  }
  ...
  getAsignaturasFiltradas(
    ...
    return this.asignaturas.filter((e) => {
      return (
        e.nombre.toLowerCase().includes(nom.toLowerCase()) &&
        e.ciclo.toLowerCase().match(ciclo.toLowerCase()) &&
        e.conocimientos.find((element) =>
          element.nombre.toLowerCase().match(conocimiento.toLowerCase())
        )
      );
    });
  }
